...
export function EnhancedChatInterface({
  ...
  const [messages, setMessages] = React.useState<any[]>(() => {
    if (isDataReady && processedData) {
      return [
        {
          id: 'welcome',
          role: 'assistant',
          content: `Hello! I've successfully analyzed your ${
            processedData.totalFiles
          } business document(s) using Google's Gemini AI:
\n${processedData.processedFiles
            ?.map(
              (file: any) =>
                `• ${file.name} (${file.type}) - Analyzed by ${file.agent}`
            )
            .join(
              '\n'
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // API returns { message: { id, role: "assistant", content } } or { error }
      ...
      <Card className='border-0 shadow-xl bg-white/80 backdrop-blur-sm'>
        <CardHeader className='text-center pb-6'>
          ...
          <CardDescription className='text-lg text-gray-600 max-w-2xl mx-auto'>
            Process your business documents to unlock Gemini AI-powered insights
            and recommendations
          </CardDescription>
        </CardHeader>
            ...
            {uploadedFiles.length > 0 ? (
              <div className='max-w-md mx-auto p-6 bg-gradient-to-r from-amber-50 to-orange-50 rounded-2xl border border-amber-200 shadow-lg'>
                ...
                <p className='text-amber-700 text-sm mb-4'>
                  You have {uploadedFiles.length} file(s) uploaded. Process them
                  to start getting Gemini AI insights.
                </p>
                <Button
                  variant='outline'
              ...
              <div>
                ...
                <p className='text-gray-400 mb-6'>
                  Upload your business files to begin Gemini AI analysis
                </p>
                <Button
                  variant='outline'
                  size='lg'
    ...
    <div className='space-y-6'>
      ...
      <Card className='border-0 shadow-lg bg-gradient-to-r from-emerald-50 to-teal-50 border-emerald-200'>
        <CardHeader>
          ...
          <CardDescription className='text-emerald-700'>
            Your specialized AI agents powered by Google Gemini have analyzed
            all documents
          </CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Card className='border-0 shadow-lg bg-white/90 backdrop-blur-sm'>
        <CardHeader>
          ...
          <CardDescription>
            Click any question below to get instant AI analysis of your data
          </CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Card className='border-0 shadow-xl bg-white/90 backdrop-blur-sm h-[600px] flex flex-col'>
        <CardHeader className='border-b border-gray-100'>
          ...
          <CardDescription>
            Ask questions about your data and get detailed, actionable insights
